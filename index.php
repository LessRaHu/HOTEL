        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="header-button">
                    <a href="nuevo.php">
                        <button type="button" class="btn btn-primary" style="background-color: #333;">Agregar nuevo Cliente</button>
                    </a>
                </div>
                <div class="p-4">
                    <div class="table-responsive">
                        <table class="table table-dark table-striped w-100 max-width-lg">
                            <thead>
                                <tr>
                                    <th scope="col">ID</th>
